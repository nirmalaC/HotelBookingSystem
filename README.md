...
- src/test/java/stepDefinitions/ApiTest - This is the cucumber test runner file used to run api tests.
...
- Go to TestRunner file and right click and click run button to run individual tests
OR
